...
`del`(deletion), `dup`(duplication), `trans_chrom` (translocate
chromosome), `trans_balance`(balanced translocation chromosome),
`trans_unbalance` (unbalanced translocation chromosome).
