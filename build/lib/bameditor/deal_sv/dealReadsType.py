...
def deal_type3(reads_type3_left, reads_type3_right, freq, insertSize, start, end, svtype, supple1=None, supple2=None,
    ...
    if svtype == "del":
        if len(supple1) == 0:
            print "Step3: No corresponding reads to pair"
            return False
        for read_pair_id in reads_left_mend_id:
            ...
            try_time = 0
            while True:
                read_right = random.sample(supple1, 1)[0][1]
    ...
    if svtype == "dup":
        ...
        for read_pair_id in reads_left_mend_id:
            ...
            try_time = 0
            while True:
                read_left = random.sample(reads_type3_right, 1)[0][0]
        ...
        for read_pair_id in reads_left_mend_id:
            ...
            try_time = 0
            while True:
                read_right = copy.deepcopy(random.sample(reads_type4, 1)[0][1])
        ...
        for read_pair_id in reads_right_mend_id:
            ...
            try_time = 0
            while True:
                read_left = copy.deepcopy(random.sample(reads_type4, 1)[0][0])
        ...
        for read_pair_id in reads_left_mend_id:
            ...
            try_time = 0
            while True:
                read_right = random.sample(reads_left_sub, 1)[0][1]
        ...
        for read_pair_id in reads_right_mend_id:
            ...
            try_time = 0
            while True:
                read_left = random.sample(reads_right_sub, 1)[0][0]
